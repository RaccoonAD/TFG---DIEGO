...
struct OdomInfo_
{
  ...
  _localBundleIds_type localBundleIds;
   ...
   typedef std::vector< ::rtabmap_ros::CameraModels_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::rtabmap_ros::CameraModels_<ContainerAllocator> >::other >  _localBundleModels_type;
